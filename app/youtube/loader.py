...
class YoutubeAudioLoader(BlobLoader):
    ...
    def yield_blobs(self) -> Iterable[Blob]:
        ...
        while trial < max_trials:
            logging.debug(f"Download youtube {self.urls}, trial {trial}/{max_trials}")
            ...
            try:
                ...
                if contains_keywords(e, keywords):
                    ...
                    logging.debug(f"Exception '{e}' does not contain keywords: '{keywords}', raising exception higher")
                    raise e
